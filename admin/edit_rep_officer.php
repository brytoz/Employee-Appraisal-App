...
<?php
          ...
          $valid_email="/^[a-zA-Z0-9+-=?^_{|}~]+/";
            ...
            else
            {
                 ...
                 $valid_name="/^[a-zA-Z]+/";
                  ...
                  {
                    $designation=$_POST['up-designation'];
                    $valid_name="/^[a-zA-Z]+/";
                    ...
                    {
                      $query = "update reporting_officer set 
                      rep_off_id='$rep_id',
                      passwd='$pas',
                      name='$name',
    ...
    {
      //echo $id;
      $query = "delete from reporting_officer where rep_off_id='$id'";
      sqlsrv_query($conn,$query) or die('Error in deletion');
      $query = "update employee set rep_off_id='' where rep_off_id='$id'";
      sqlsrv_query($conn,$query) or die('Error in deletion');
...
<!--////////////////////////PHP END/////////////////////////////////////-->
    ...
    <div class="container col-sm-6">
            ...
            <form role="form" action="" name="add-form" method="post">
              ...
              <input type="text" name="up-id" class="form-control" value="<?=$row['rep_off_id']?>">
              </div>
