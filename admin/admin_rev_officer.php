...
<!--Actions that can be performed by admin on a officer-->
 ...
 <!--option no-1 Add an officer-->
 				<div id="add" class="tab-pane fade in active">
 					<h3>Add Officer</h3>
						<form role="form" action ="admin_rev_officer_back.php" method="post" name="add-form">
...
<!--option no-3 edit an officer-->				
				<div id="edit" class="tab-pane fade">
					<h3>Edit Officer</h3>
						<form role="form" method="post" action="admin_rev_officer_back.php" name="edit-form" >
...
<!--option no-4 assign an officer's details -->
				<div id="assign" class="tab-pane fade">
					<h3>Assign Reporting Officer</h3>
						<form role="form" action="admin_rev_officer_back.php" method="post" name="as-form">
							<div class="form-group">
